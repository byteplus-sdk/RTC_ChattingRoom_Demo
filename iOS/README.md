Chatting room is an open source sample project provided by BytePlus RTC. This topic describes how to run this sample project to try a chatting room.

## **Note**

After using the project file to build an application, you can use the built application to have a chatting.
You and your colleagues must join the same room to have a online chatting.
...
1. Open a CLI on a terminal and go to the root directory `RTC_ChattingRoom_Demo/iOS/RTCSolution`.
...
3. Go to the root directory `RTC_ChattingRoom_Demo/iOS/RTCSolution`. Launch Xcode and open the file `RTCSolution.xcworkspace<br>
