...
public class VoiceChatRoomMainActivity extends SolutionBaseActivity {
    ...
    /**
     * Set the background of the anchor room according to the additional information of entering the room
     * @param ext extra information json
     */
