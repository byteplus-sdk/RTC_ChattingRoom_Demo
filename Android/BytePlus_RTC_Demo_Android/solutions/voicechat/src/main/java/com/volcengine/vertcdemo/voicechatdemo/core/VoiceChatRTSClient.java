...
public class VoiceChatRTSClient extends RTSBaseClient {
    ...
    public VoiceChatRTSClient(RTCVideo video, RTSInfo rtmInfo) {
        super(video, rtmInfo);
    }
    ...
    public void manageInteractApply(String roomId, @VoiceChatDataManager.AllowUserApplyType int type, IRequestCallback<RTSBizResponse> callback) {
